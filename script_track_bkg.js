...
textureLoader.load(
    ...
    (texture) => {
        ...
        const geometry = new THREE.SphereGeometry(2000, 32, 32); // Radius 2000
        ...
        skybox.position.set(0, 0, 0); // Initial position, will follow camera
        scene.add(skybox);
        console.log('Desert skybox loaded at:', skybox.position, 'Scale:', skybox.scale);
        console.log('Scene children after adding skybox:', scene.children);
    },
...
// ATV physics
const chassisShape = new CANNON.Box(new CANNON.Vec3(1, 0.5, 1)); // Fixed typo here
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        chassisBody.quaternion.copy(atvMesh.quaternion); // Fixed typo here too
